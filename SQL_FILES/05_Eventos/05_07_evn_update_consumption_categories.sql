CREATE EVENT evt_update_consumption_categories
...
DO BEGIN
    ...
    VALUES (
        CONCAT('Iniciando evento centralizado evt_update_consumption_categories a las ', 
    ...
    CALL fn_update_category_totals_hora(v_hora_anterior, v_hora_actual);
    
    -- 2. Ejecutar actualización de categorías por día
    CALL fn_update_category_totals_dia(v_dia_anterior, v_dia_actual);
    
    -- 3. Ejecutar actualización de categorías por mes
    CALL fn_update_category_totals_mes(
    ...
    INSERT INTO process_log (message) 
    VALUES (
        CONCAT('Finalizado evento centralizado evt_update_consumption_categories a las ', 
