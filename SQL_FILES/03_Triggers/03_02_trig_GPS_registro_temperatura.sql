CREATE DEFINER=`root`@`%` TRIGGER `trig_GPS_registro_temperatura`
...
BEGIN
    ...
    WHILE counter < array_length DO
        ...
        INSERT INTO log_proceso(mensaje) VALUES(temperatura);
        IF temperatura IS NOT NULL THEN
            ...
            IF mac_address IS NOT NULL THEN
                ...
                INSERT INTO log_proceso(mensaje) VALUES (CONCAT('%',  mac_address, '%', ' esTemperatura:_',es_Temperatura));
            ELSE
                ...
                INSERT INTO log_proceso(mensaje) VALUES (CONCAT('%',  beacon_id, '%', ' esTemperatura:_',es_Temperatura));
            END IF;
            ...
            IF es_Temperatura = 1 THEN
                ...
                INSERT INTO log_proceso(mensaje) VALUES(concat("INSERT INTO teltonika.registro_temperaturas(beacon_id, timestamp, temperatura)
                VALUES (beacon_id, FROM_UNIXTIME(NEW.timestamp),",temperatura));
            END IF;
        END IF;
    ...
    INSERT INTO log_proceso(mensaje) VALUES("Proceso de registro de temperaturas completado");
END
